...
**Uriary**는 소중한 사람들과 함께 추억을 기록하고 공유하는 크로스플랫폼 소셜 다이어리 애플리케이션입니다. React Native와 Expo를 기반으로 iOS, Android, Web 환경을 모두 지원합니다.
...
- **교환일기:** 그룹 멤버들과 함께 작성하고 공유하는 다이어리
- **댓글:** 다이어리에 대한 멤버들의 소통 기능
